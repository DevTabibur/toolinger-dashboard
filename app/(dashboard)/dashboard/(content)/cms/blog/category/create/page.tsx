...
} from '@/redux/api/blogCategory.api';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-zinc-500 mt-1">
                        {t('Add a new blog category to organize your content')}
                    </p>
                </div>
            ...
            <DashboardBreadcrumb
                items={[
                    { label: t('Content (CMS)') },
                    { label: t('Blog') },
                    { label: t('Blog Categories'), href: '/dashboard/cms/blog/category' },
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <p className="mt-1.5 text-xs text-zinc-500 flex items-start gap-1">
                                                <FiAlertCircle className="w-4 h-4 font-bold  flex-shrink-0 text-amber-500" />
                                                <span>Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional</span>
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1.5 text-xs text-zinc-500 flex items-start gap-1">
                                                <FiAlertCircle className="w-4 h-4 font-bold  flex-shrink-0 text-amber-500" />
                                                <span>Set category visibility status</span>
                                            </p>
                                        </div>
                                    ...
                                    <div className="border-t border-zinc-200 dark:border-zinc-800 pt-6">
                                        <div className="flex items-start gap-3">
                                            ...
                                            />
                                            <div>
                                                <p className="text-sm font-medium">System Category</p>

                                                <p className="text-xs text-zinc-500 mt-1 flex items-start gap-1">
                                                    <FiAlertCircle className="w-4 h-4 font-bold  flex-shrink-0 text-amber-500" />
                                                    <span>System categories are protected and cannot be deleted by regular users</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="text-xs text-blue-800 dark:text-blue-200 space-y-1 list-disc list-inside">
                            <li>Use clear, descriptive names that help users understand the content</li>
                            <li>Keep category names concise (2-100 characters)</li>
                            <li>Slugs are automatically generated but can be customized</li>
                            <li>Parent categories help organize content hierarchically</li>
                            <li>Descriptions are optional but recommended for SEO</li>
                        </ul>
                    </div>
                </div>
            </div>
