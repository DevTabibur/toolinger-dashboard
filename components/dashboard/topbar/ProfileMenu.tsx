    ...
    return (
        <div className="relative" ref={containerRef}>
            <button
                ...
                className="flex items-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-800 p-1.5 pr-3  transition-colors border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700"
            >
                <img
                            ...
                            {ProfileMenuData.map((item) => {
                                ...
                                return (
                                    <Link
                                        key={item.id}
                                        href={item.href}
                                        className="w-full flex items-center gap-3 px-3 py-2.5  text-sm text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors"
                                    >
