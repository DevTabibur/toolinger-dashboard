    ...
    return (
        <div className="w-full">
            ...
            <div className="relative">
                <select
                    className={clsx(
                        "w-full  border bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] transition-all appearance-none py-2 pl-3 pr-10 text-sm",
                        error
