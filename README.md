## Future Task
1. dashboard category list page e, active and inactive koto gula, category ase, seigula table er header e show korano gele valo hoto. and bulk delete option thakleu valo hoto.  ex: ![alt text](image-1.png) and,![alt text](image-2.png) 
...
6. user details show korano lagbe. table theke, like the image ![alt text](image-3.png).
7. user manage table ee user role gula different color e , different role show korano lagbe pore. ![alt text](image-4.png)
